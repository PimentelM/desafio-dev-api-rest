    ...
    describe("Exemplos de teste unitário", () => {
        ...
        describe("Sacar Valor", () => {
            ...
            beforeEach(()=>{
                ...
                mockRepository.getContaById = (id) => getMockConta({saldo: 100, flagAtivo: true, limiteSaqueDiario: 50})
            ...
            it("A conta deve existir para que o saque seja realizado", async () => {
                ...
                let action = async () => await service.sacarValor(`112233445566112233445566`, 10)
            ...
            it("A conta deve estar ativa para que o saque seja realizado", async () => {
                // Redefine a função que obtem contas do repositório
                mockRepository.getContaById = (id) => getMockConta({ flagAtivo: false})
            ...
            it("A conta deve possuir saldo suficiente para que o saque seja realizado", async () => {
                let action = async () => await service.sacarValor(`112233445566112233445566`, 200)
            ...
            it("O saque não deve ser maior que o limite de saque diário", async () => {
                let action = async () => await service.sacarValor(`112233445566112233445566`, 60)
            ...
            it("O cálculo do extrapolamento do limite de saque diário deve levar em conta as transações feitas no dia", async () => {
                ...
                let action = async () => await service.sacarValor(`112233445566112233445566`, 20)
            ...
            it("Deve ser possível sacar valor", async () => {
                ...
                expect(mockRepository.realizarTransacao).toHaveBeenLastCalledWith(`112233445566112233445566`, -20)
